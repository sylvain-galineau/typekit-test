...
function $JSCompiler_StaticMethods_updateClassName$$($e$$15$$, $add_opt_add_remainingClasses$$, $opt_remove_remove$$) {
  ...
  for (var $classes$$ = $e$$15$$.className.baseVal.split(/\s+/), $i$$7$$ = 0;$i$$7$$ < $add_opt_add_remainingClasses$$.length;$i$$7$$ += 1) {
  ...
  $e$$15$$.setAttribute("class", $add_opt_add_remainingClasses$$.join(" ").replace(/\s+/g, " ").replace(/^\s+|\s+$/, ""));
}
